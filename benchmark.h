...
void executarTesteGenerico(AlgoritmoOrdenacao func);//Tratam funções que retornam as métricas como resultado
void executarTesteParametrizado(AlgoritmoParametrizado func);//Tratam funções que alteram as métricas por parâmetro
